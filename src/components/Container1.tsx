  ...
  return (
    ...
    >
      ...
      <div className="w-[780px] flex flex-row items-center justify-center py-0 px-5 box-border max-w-full text-xs text-darkslategray-100 font-open-sans">
        ...
        >
          <button className="cursor-pointer border-darkslategray-100 border-[1px] border-solid py-1.5 px-[7px] bg-darkslategray-100 w-[85px] rounded-81xl box-border flex flex-row items-center justify-center whitespace-nowrap hover:bg-dimgray-300 hover:border-dimgray-300 hover:border-[1px] hover:border-solid hover:box-border">
          ...
          <div
            ...
            style={tag1Style}
          >
            <div className="relative" style={tagOrButton1Style}>
              {tagOrButton1}
            </div>
          </div>
          <button className="cursor-pointer border-darkslategray-100 border-[1px] border-solid py-1.5 px-[7px] bg-[transparent] rounded-81xl flex flex-row items-center justify-center whitespace-nowrap hover:bg-dimgray-400 hover:border-dimgray-300 hover:border-[1px] hover:border-solid hover:box-border">
