  ...
  return (
    ...
    >
      <div className="self-stretch flex flex-row items-center justify-center py-2.5 px-0 box-border max-w-full">
        <h1 className="m-0 flex-1 relative text-inherit leading-[20px] font-normal font-[inherit] text-transparent !bg-clip-text [background:linear-gradient(#111827,_#111827),_rgba(17,_24,_39,_0.5)] [-webkit-background-clip:text] [-webkit-text-fill-color:transparent] inline-block max-w-full mq750:text-13xl mq750:leading-[16px] mq450:text-5xl mq450:leading-[12px]">
          About
        </h1>
      </div>
