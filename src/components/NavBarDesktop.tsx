...
const NavBarDesktop: FunctionComponent<NavBarDesktopType> = ({
  ...
  return (
    <div
      className={`flex-1 flex flex-row items-center justify-between py-4 px-[19px] box-border max-w-full text-left text-lg text-gray-900 font-btn-text ${className}`}
    >
